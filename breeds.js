...
function zad1(x) {
    return x.reduce(function (output, {
        country_code,
        origin
    }) {
        output[country_code] = origin;
        return output;
    }, {});
}
...
function zad3(x) {
    return x.reduce(function (output, {
        ...
        output[intelligence] = [name] //tylko ostatnie wystapienia. problem z petla, problem z "const intelligenceList"
        return output;
    }, {});
}
